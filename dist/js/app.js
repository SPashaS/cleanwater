(() => {
  ...
  (() => {
          ...
          for (let t = 0, i = s.length; t < i; t += 1) {
            ...
            void 0 !== r &&
              ...
              (g(e[i]) && g(n[i])
                ...
                : !g(e[i]) && g(n[i])
                  ? ((e[i] = {}),
                    n[i].__swiper__ ? (e[i] = n[i]) : v(e[i], n[i]))
                  : (e[i] = n[i]));
          }
        }
      }
    ...
    var N = {
      ...
      updateSlides: function () {
        ...
        const s = e.params,
          ...
          c = y(n, `.${e.params.slideClass}, swiper-slide`),
        ...
        for (let i = 0; i < p; i += 1) {
          ...
          if (
            ((M = 0),
            c[i] && (n = c[i]),
            L && e.grid.updateSlide(i, n, c),
            !c[i] || "none" !== T(n, "display"))
          ) {
            if ("auto" === s.slidesPerView) {
              ...
              (M = (r - (s.slidesPerView - 1) * E) / s.slidesPerView),
                s.roundLengths && (M = Math.floor(M)),
        ...
        if (
          ...
          L && e.grid.updateWrapperSize(M, u),
          !s.centeredSlides)
        ) {
          const t = [];
    ...
    function j(e) {
      ...
      d && i.target && i.target.shadowRoot && p && (l = p[0]);
    ...
    function W(e) {
      ...
      if (p > r.longSwipesMs) {
        ...
        "next" === t.swipeDirection &&
          (y >= r.longSwipesRatio
            ? t.slideTo(r.rewind && t.isEnd ? b : g + E)
            : t.slideTo(g)),
        ...
        (n.target === t.navigation.nextEl || n.target === t.navigation.prevEl)
          ? n.target === t.navigation.nextEl
            ? t.slideTo(g + E)
            : t.slideTo(g)
          : ("next" === t.swipeDirection && t.slideTo(null !== b ? b : g + E),
    ...
    class ne {
      ...
      getSlideIndex(e) {
        const { slidesEl: t, params: s } = this,
          i = x(y(t, `.${s.slideClass}, swiper-slide`)[0]);
        return x(e) - i;
      }
    ...
    window.addEventListener("load", function (e) {
      de(),
        document.querySelector(".why__swiper") &&
          new ne(".why__slider", {
            modules: [ae, le],
            slidesPerView: 1,
            spaceBetween: 20,
            ...
            navigation: {
              prevEl: ".service__slider-nav .service__slider-btn_prev",
              nextEl: ".service__slider-nav .service__slider-btn_next",
            },
            breakpoints: {
    ...
    new ce("min").init();
    const pe = document.querySelector(".menu__list");
    if (pe) {
      pe.querySelectorAll(".menu-item a").forEach((e) => {
